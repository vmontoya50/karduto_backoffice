...
export class ViewComponent implements OnInit
{
    ...
    dataUserCuenta(id): any{

        this._fuseProgressBarService.show();
        this.api.get('cuentas/user/' + id)
            .subscribe( result => {

                console.log('CUENTAXUSER::', result);
                this.dataUserCuent = result;
    ...
    deleteOn(cuentaId, UserId): any{
        console.log('DELETEON::', [cuentaId, UserId]);
        this._fuseProgressBarService.show();
        this.api.post('cuentas/eliminar', {usuario: UserId, cuenta:cuentaId})
            .subscribe( result => {
                console.log('ELIMINAR::', result);
                this.dataComponent(this.idCuenta);
                this._fuseProgressBarService.hide();
                this.dataUserCuenta(this.idCuenta);
