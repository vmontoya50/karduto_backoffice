...
@Component({
  selector: 'agregar-tasa-dialog',
  templateUrl: './dialog.component.html',
  styleUrls: ['./dialog.component.scss'],
  encapsulation: ViewEncapsulation.None
})

export class AgregarTasaDialogComponent implements OnInit {
  ...
  constructor(
      ...
      public matDialogRef: MatDialogRef<AgregarTasaDialogComponent>,
  ...
  public formGroup(): FormGroup {
    ...
    return new FormGroup({
      ...
      moneda_cambio_id: new FormControl('', [Validators.required]),
  ...
  _setDialog(): void{
    ...
    // form.moneda_cambio_id = 1;
    this.api.post('tasa', form)
        .subscribe( data => {
