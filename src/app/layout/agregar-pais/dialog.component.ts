...
@Component({
  selector: 'agregar-pais-dialog',
  templateUrl: './dialog.component.html',
  styleUrls: ['./dialog.component.scss'],
  encapsulation: ViewEncapsulation.None
})

export class AgregarPaisDialogComponent implements OnInit {
  ...
  constructor(
      ...
      public matDialogRef: MatDialogRef<AgregarPaisDialogComponent>,
